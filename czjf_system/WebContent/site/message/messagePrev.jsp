	      ...
	      <div id="welcome">
	        <div>
	           <div class="c1-body">
                    ...
                    <!-- 遍历最新留言 start -->
			      <c:forEach items="${list}" var="message" varStatus="sta">
                       <div class="c1-bline" style="padding:7px 0px;">
                        <div class="f-left">
                             <img src="/czjf_system/img/head-mark4.gif" align="middle" class="img-vm" border="0"/> 
                             <a href="${pageContext.request.contextPath}/MessageServlet?method=findMessageById&id=${message.messageId}"  class="pn-loperator" style="color: red">
			                     ${message.content}
			                 </a>
                        </div>
	        ...
	        <p class="more"><a href="${pageContext.request.contextPath}/MessageServlet?method=findMessagesWithPage&num=1">更多</a></p>
