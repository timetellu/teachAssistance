	      ...
	      <div id="welcome">
	        <div>
	           <div class="c1-body">
			        ...
			        <c:forEach items="${page.list}" var="cour" varStatus="sta">
                        <div class="c1-bline" style="padding:7px 0px;">
	                        <div class="f-left">
	                             <img src="/czjf_system/img/head-mark4.gif" align="middle" class="img-vm" border="0"/> 
	                             <a href="${pageContext.request.contextPath}/CourseServlet?method=findCourseById&id=${cour.cId}">
	                             	${cour.cName}
	                             </a>
	                        </div>
	                        <div class="f-right">${cour.teaRealName}</div>
	                        <div class="clear"></div>
                        </div>
                    </c:forEach>
