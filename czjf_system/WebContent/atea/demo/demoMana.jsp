	...
	<body leftmargin="2" topmargin="2" background='/czjf_system/images/allbg.gif'>
			<table class="table table-bordered table-hover" width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
				...
				<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
					...
					<td bgcolor="#FFFFFF" align="center">
						<a href="${pageContext.request.contextPath}/DemoServlet?method=downloadDemo&id=${d.demoId}" style="font-size: 13px;">${d.attachmentOldName}</a>
					</td>
					<td bgcolor="#FFFFFF" align="center">
					...
					<td bgcolor="#FFFFFF" align="center">
					    <%--取消链接的默认行为 --%>
						<a href="javascript:void(0)" onclick="delDemo(${d.demoId})"  class="pn-loperator">删除</a>
...
<script>
	function delDemo(demoId){
		//做删除demo之前的确认提示
		if(confirm("确认删除当前的DEMO吗?")){
			//向服务端发起请求，将当前正在删除的资料的编号发送到服务端
			location.href="${pageContext.request.contextPath}/DemoServlet?method=deleteDemoByTeacher&id="+demoId;
		}
	}
